...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-bulletins" }, _attrs))} data-v-f3d26f88><header class="page-header" data-v-f3d26f88><div class="header-content" data-v-f3d26f88><h2 data-v-f3d26f88>Génération des Bulletins</h2><p data-v-f3d26f88>Générez les bulletins PDF et exportez les données Excel pour les étudiants.</p></div></header><div class="filters-section" data-v-f3d26f88><div class="filter-row" data-v-f3d26f88><div class="filter-group" data-v-f3d26f88><label for="promotion" data-v-f3d26f88>Promotion:</label><select id="promotion" class="form-control" data-v-f3d26f88><option value="2025-2026" data-v-f3d26f88${ssrIncludeBooleanAttr(Array.isArray(filters.value.promotion) ? ssrLooseContain(filters.value.promotion, "2025-2026") : ssrLooseEqual(filters.value.promotion, "2025-2026")) ? " selected" : ""}>2025-2026</option><option value="2024-2025" data-v-f3d26f88${ssrIncludeBooleanAttr(Array.isArray(filters.value.promotion) ? ssrLooseContain(filters.value.promotion, "2024-2025") : ssrLooseEqual(filters.value.promotion, "2024-2025")) ? " selected" : ""}>2024-2025</option></select></div><div class="filter-group" data-v-f3d26f88><label for="semestre" data-v-f3d26f88>Semestre:</label><select id="semestre" class="form-control" data-v-f3d26f88><option value="" data-v-f3d26f88${ssrIncludeBooleanAttr(Array.isArray(filters.value.semestre) ? ssrLooseContain(filters.value.semestre, "") : ssrLooseEqual(filters.value.semestre, "")) ? " selected" : ""}>Tous</option><option value="S5" data-v-f3d26f88${ssrIncludeBooleanAttr(Array.isArray(filters.value.semestre) ? ssrLooseContain(filters.value.semestre, "S5") : ssrLooseEqual(filters.value.semestre, "S5")) ? " selected" : ""}>Semestre 5</option><option value="S6" data-v-f3d26f88${ssrIncludeBooleanAttr(Array.isArray(filters.value.semestre) ? ssrLooseContain(filters.value.semestre, "S6") : ssrLooseEqual(filters.value.semestre, "S6")) ? " selected" : ""}>Semestre 6</option></select></div><div class="filter-group" data-v-f3d26f88><label for="statut" data-v-f3d26f88>Statut:</label><select id="statut" class="form-control" data-v-f3d26f88><option value="" data-v-f3d26f88${ssrIncludeBooleanAttr(Array.isArray(filters.value.statut) ? ssrLooseContain(filters.value.statut, "") : ssrLooseEqual(filters.value.statut, "")) ? " selected" : ""}>Tous</option><option value="valide" data-v-f3d26f88${ssrIncludeBooleanAttr(Array.isArray(filters.value.statut) ? ssrLooseContain(filters.value.statut, "valide") : ssrLooseEqual(filters.value.statut, "valide")) ? " selected" : ""}>Validé</option><option value="admissible" data-v-f3d26f88${ssrIncludeBooleanAttr(Array.isArray(filters.value.statut) ? ssrLooseContain(filters.value.statut, "admissible") : ssrLooseEqual(filters.value.statut, "admissible")) ? " selected" : ""}>Admissible</option><option value="non_valide" data-v-f3d26f88${ssrIncludeBooleanAttr(Array.isArray(filters.value.statut) ? ssrLooseContain(filters.value.statut, "non_valide") : ssrLooseEqual(filters.value.statut, "non_valide")) ? " selected" : ""}>Non validé</option></select></div></div><div class="filter-actions" data-v-f3d26f88><button class="btn btn-primary" data-v-f3d26f88><span data-v-f3d26f88>Appliquer</span></button><button class="btn btn-secondary" data-v-f3d26f88><span data-v-f3d26f88>Réinitialiser</span></button></div></div><div class="stats-section" data-v-f3d26f88><div class="stats-grid" data-v-f3d26f88><div class="stat-card" data-v-f3d26f88><h4 data-v-f3d26f88>${ssrInterpolate(stats.value.total_etudiants)}</h4><p data-v-f3d26f88>Total Étudiants</p></div><div class="stat-card success" data-v-f3d26f88><h4 data-v-f3d26f88>${ssrInterpolate(stats.value.diplomes)}</h4><p data-v-f3d26f88>Diplômés</p></div><div class="stat-card warning" data-v-f3d26f88><h4 data-v-f3d26f88>${ssrInterpolate(stats.value.admissibles)}</h4><p data-v-f3d26f88>Admissibles</p></div><div class="stat-card danger" data-v-f3d26f88><h4 data-v-f3d26f88>${ssrInterpolate(stats.value.redoublants)}</h4><p data-v-f3d26f88>Redoublants</p></div></div></div><div class="actions-section" data-v-f3d26f88><h3 data-v-f3d26f88>Actions de Génération</h3><div class="action-grid" data-v-f3d26f88><div class="action-card" data-v-f3d26f88><h4 data-v-f3d26f88>Génération Individuelle</h4><p data-v-f3d26f88>Générez des bulletins pour des étudiants spécifiques</p><div class="action-controls" data-v-f3d26f88><select class="form-control" data-v-f3d26f88><option value="" data-v-f3d26f88${ssrIncludeBooleanAttr(Array.isArray(selectedEtudiant.value) ? ssrLooseContain(selectedEtudiant.value, "") : ssrLooseEqual(selectedEtudiant.value, "")) ? " selected" : ""}>Choisir un étudiant...</option><!--[-->`);
      ...
      _push(`<!--]--></select><div class="button-group" data-v-f3d26f88><button${ssrIncludeBooleanAttr(!selectedEtudiant.value) ? " disabled" : ""} class="btn btn-primary" data-v-f3d26f88><span data-v-f3d26f88>PDF</span> Bulletin S5 </button><button${ssrIncludeBooleanAttr(!selectedEtudiant.value) ? " disabled" : ""} class="btn btn-primary" data-v-f3d26f88><span data-v-f3d26f88>PDF</span> Bulletin S6 </button><button${ssrIncludeBooleanAttr(!selectedEtudiant.value) ? " disabled" : ""} class="btn btn-success" data-v-f3d26f88><span data-v-f3d26f88>PDF</span> Bulletin Annuel </button></div></div></div><div class="action-card" data-v-f3d26f88><h4 data-v-f3d26f88>Génération par Lot</h4><p data-v-f3d26f88>Générez tous les bulletins pour la promotion</p><div class="action-controls" data-v-f3d26f88><div class="checkbox-group" data-v-f3d26f88><label data-v-f3d26f88><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(batchOptions.value.S5) ? ssrLooseContain(batchOptions.value.S5, null) : batchOptions.value.S5) ? " checked" : ""} data-v-f3d26f88> Bulletins S5 </label><label data-v-f3d26f88><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(batchOptions.value.S6) ? ssrLooseContain(batchOptions.value.S6, null) : batchOptions.value.S6) ? " checked" : ""} data-v-f3d26f88> Bulletins S6 </label><label data-v-f3d26f88><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(batchOptions.value.annuel) ? ssrLooseContain(batchOptions.value.annuel, null) : batchOptions.value.annuel) ? " checked" : ""} data-v-f3d26f88> Bulletins Annuels </label></div><button${ssrIncludeBooleanAttr(!hasBatchOption.value) ? " disabled" : ""} class="btn btn-success" data-v-f3d26f88><span data-v-f3d26f88>PDF</span> Générer le Lot </button></div></div><div class="action-card" data-v-f3d26f88><h4 data-v-f3d26f88>Export Excel</h4><p data-v-f3d26f88>Exportez les données en format Excel</p><div class="action-controls" data-v-f3d26f88><div class="button-group" data-v-f3d26f88><button class="btn btn-secondary" data-v-f3d26f88><span data-v-f3d26f88>Excel</span> Relevé S5 </button><button class="btn btn-secondary" data-v-f3d26f88><span data-v-f3d26f88>Excel</span> Relevé S6 </button><button class="btn btn-info" data-v-f3d26f88><span data-v-f3d26f88>Excel</span> Décisions Jury </button></div></div></div></div></div><div class="table-section" data-v-f3d26f88><h3 data-v-f3d26f88>Liste des Étudiants</h3><div class="table-container" data-v-f3d26f88><table class="students-table" data-v-f3d26f88><thead data-v-f3d26f88><tr data-v-f3d26f88><th data-v-f3d26f88>Matricule</th><th data-v-f3d26f88>Nom</th><th data-v-f3d26f88>Prénom</th><th data-v-f3d26f88>Moyenne S5</th><th data-v-f3d26f88>Crédits S5</th><th data-v-f3d26f88>Moyenne S6</th><th data-v-f3d26f88>Crédits S6</th><th data-v-f3d26f88>Moyenne Annuelle</th><th data-v-f3d26f88>Décision</th><th data-v-f3d26f88>Actions</th></tr></thead><tbody data-v-f3d26f88><!--[-->`);
      ssrRenderList(filteredEtudiants.value, (etudiant) => {
...
//# sourceMappingURL=bulletins-pzfT4SXi.js.map
