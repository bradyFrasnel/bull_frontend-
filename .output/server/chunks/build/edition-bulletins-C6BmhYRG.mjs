...
const _sfc_main = {
  ...
  setup(__props) {
    useHead({ title: "\xC9dition des Bulletins | Bull ASUR" });
    ...
    const tabs = [
      ...
      { id: "ues", label: "Unit\xE9s d'Enseignement" },
      { id: "matieres", label: "Mati\xE8res" },
      { id: "absences", label: "Absences" }
    ];
    const semestreColumns = [
      { key: "libelle", label: "Libell\xE9" },
      { key: "annee_universitaire", label: "Ann\xE9e universitaire" }
    ];
    const ueColumns = [
      { key: "code", label: "Code" },
      { key: "libelle", label: "Libell\xE9" },
    ...
    const matiereColumns = [
      ...
      { key: "credits", label: "Cr\xE9dits ECTS" },
      { key: "ue", label: "UE" }
    ];
    const absenceColumns = [
      { key: "etudiant", label: "\xC9tudiant" },
      { key: "matiere", label: "Mati\xE8re" },
    ...
    const deleteItem = async (type, itemId) => {
      const typeLabels = {
        ...
        ue: "cette UE",
        matiere: "cette mati\xE8re",
        absence: "cette absence"
      };
      if (!confirm(`\xCAtes-vous s\xFBr de vouloir supprimer ${typeLabels[type]} ?`)) {
        return;
      }
      try {
        const apiEndpoints = {
        ...
        console.log(`${type} supprim\xE9 avec succ\xE8s`);
      } catch (error) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-edition-bulletins" }, _attrs))} data-v-827e4bc2><header class="page-header" data-v-827e4bc2><div class="header-content" data-v-827e4bc2><h2 data-v-827e4bc2>\xC9dition des Bulletins</h2><p data-v-827e4bc2>Gestion de la structure des bulletins : semestres, UE, mati\xE8res et absences.</p></div></header><div class="tabs-container" data-v-827e4bc2><div class="tabs" data-v-827e4bc2><!--[-->`);
      ...
      if (activeTab.value === "semestres") {
        ...
        _push(ssrRenderComponent(_component_DataTable, {
          ...
          actions: withCtx(({ row }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button class="btn btn-sm btn-secondary" data-v-827e4bc2${_scopeId}> \u270F\uFE0F </button><button class="btn btn-sm btn-danger" data-v-827e4bc2${_scopeId}> \u{1F5D1}\uFE0F </button>`);
            } else {
              return [
                createVNode("button", {
      ...
      if (activeTab.value === "ues") {
        _push(`<div class="tab-panel" data-v-827e4bc2><div class="panel-header" data-v-827e4bc2><h3 data-v-827e4bc2>Gestion des Unit\xE9s d&#39;Enseignement</h3><button class="btn btn-primary" data-v-827e4bc2> \u2795 Ajouter une UE </button></div><div class="table-container" data-v-827e4bc2>`);
        _push(ssrRenderComponent(_component_DataTable, {
          columns: ueColumns,
          data: ues.value,
          actions: true
      ...
      if (activeTab.value === "matieres") {
        _push(`<div class="tab-panel" data-v-827e4bc2><div class="panel-header" data-v-827e4bc2><h3 data-v-827e4bc2>Gestion des Mati\xE8res</h3><button class="btn btn-primary" data-v-827e4bc2> \u2795 Ajouter une mati\xE8re </button></div><div class="table-container" data-v-827e4bc2>`);
        _push(ssrRenderComponent(_component_DataTable, {
      ...
      _push(`</div>`);
      if (showModal.value) {
        _push(`<div class="modal-overlay" data-v-827e4bc2><div class="modal-content" data-v-827e4bc2><div class="modal-header" data-v-827e4bc2><h3 data-v-827e4bc2>${ssrInterpolate(getModalTitle())}</h3><button class="modal-close" data-v-827e4bc2>\xD7</button></div><form class="modal-form" data-v-827e4bc2>`);
        if (modalType.value === "semestre") {
          _push(`<div data-v-827e4bc2><div class="form-group" data-v-827e4bc2><label for="semestre_libelle" data-v-827e4bc2>Libell\xE9 *</label><input type="text" id="semestre_libelle"${ssrRenderAttr("value", formData.value.libelle)} required class="form-control" placeholder="Ex: Semestre 5" data-v-827e4bc2></div><div class="form-group" data-v-827e4bc2><label for="semestre_annee" data-v-827e4bc2>Ann\xE9e universitaire *</label><input type="text" id="semestre_annee"${ssrRenderAttr("value", formData.value.annee_universitaire)} required class="form-control" placeholder="Ex: 2025-2026" data-v-827e4bc2></div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (modalType.value === "ue") {
          _push(`<div data-v-827e4bc2><div class="form-group" data-v-827e4bc2><label for="ue_code" data-v-827e4bc2>Code *</label><input type="text" id="ue_code"${ssrRenderAttr("value", formData.value.code)} required class="form-control" placeholder="Ex: UE5-1" data-v-827e4bc2></div><div class="form-group" data-v-827e4bc2><label for="ue_libelle" data-v-827e4bc2>Libell\xE9 *</label><input type="text" id="ue_libelle"${ssrRenderAttr("value", formData.value.libelle)} required class="form-control" placeholder="Ex: Enseignement G\xE9n\xE9ral" data-v-827e4bc2></div><div class="form-group" data-v-827e4bc2><label for="ue_semestre" data-v-827e4bc2>Semestre *</label><select id="ue_semestre" required class="form-control" data-v-827e4bc2><option value="" data-v-827e4bc2${ssrIncludeBooleanAttr(Array.isArray(formData.value.semestre_id) ? ssrLooseContain(formData.value.semestre_id, "") : ssrLooseEqual(formData.value.semestre_id, "")) ? " selected" : ""}>S\xE9lectionner un semestre...</option><!--[-->`);
        ...
        if (modalType.value === "absence") {
          _push(`<div data-v-827e4bc2><div class="form-row" data-v-827e4bc2><div class="form-group" data-v-827e4bc2><label for="absence_etudiant" data-v-827e4bc2>\xC9tudiant *</label><select id="absence_etudiant" required class="form-control" data-v-827e4bc2><option value="" data-v-827e4bc2${ssrIncludeBooleanAttr(Array.isArray(formData.value.etudiant_id) ? ssrLooseContain(formData.value.etudiant_id, "") : ssrLooseEqual(formData.value.etudiant_id, "")) ? " selected" : ""}>S\xE9lectionner un \xE9tudiant...</option><!--[-->`);
          ssrRenderList(etudiants.value, (etudiant) => {
          ...
          _push(`<!--]--></select></div><div class="form-group" data-v-827e4bc2><label for="absence_matiere" data-v-827e4bc2>Mati\xE8re *</label><select id="absence_matiere" required class="form-control" data-v-827e4bc2><option value="" data-v-827e4bc2${ssrIncludeBooleanAttr(Array.isArray(formData.value.matiere_id) ? ssrLooseContain(formData.value.matiere_id, "") : ssrLooseEqual(formData.value.matiere_id, "")) ? " selected" : ""}>S\xE9lectionner une mati\xE8re...</option><!--[-->`);
          ssrRenderList(matieres.value, (matiere) => {
...
export { editionBulletins as default };
//# sourceMappingURL=edition-bulletins-C6BmhYRG.mjs.map
