...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const evaluationTypes = [
      { key: "controle_continu", label: "Contr\xF4le Continu" },
    ...
    const calculerMoyenne = (etudiantId) => {
      ...
      const cc = ((_a = etudiantEvaluations.find((e) => e.type === "CC")) == null ? void 0 : _a.note) || 0;
      const examen = ((_b = etudiantEvaluations.find((e) => e.type === "EXAMEN")) == null ? void 0 : _b.note) || 0;
      const rattrapage = (_c = etudiantEvaluations.find((e) => e.type === "RATTRAPAGE")) == null ? void 0 : _c.note;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page-modification-notes" }, _attrs))} data-v-6a92bfa7><header class="page-header" data-v-6a92bfa7><div class="header-content" data-v-6a92bfa7><h2 data-v-6a92bfa7>Modification des Notes</h2><p data-v-6a92bfa7>Consultation et modification des notes des \xE9tudiants par semestre et mati\xE8re.</p></div></header><div class="filters-section" data-v-6a92bfa7><div class="filter-group" data-v-6a92bfa7><label for="semestre_filter" data-v-6a92bfa7>Semestre:</label><select id="semestre_filter" class="form-control" data-v-6a92bfa7><option value="" data-v-6a92bfa7${ssrIncludeBooleanAttr(Array.isArray(filters.value.semestre_id) ? ssrLooseContain(filters.value.semestre_id, "") : ssrLooseEqual(filters.value.semestre_id, "")) ? " selected" : ""}>S\xE9lectionner un semestre...</option><!--[-->`);
      ...
      if (filters.value.semestre_id) {
        _push(`<div class="notes-container" data-v-6a92bfa7><div class="table-header" data-v-6a92bfa7><h3 data-v-6a92bfa7>Notes ${ssrInterpolate(getMatiereLibelle(filters.value.matiere_id) || "du semestre")}</h3><div class="batch-actions" data-v-6a92bfa7><button class="btn btn-secondary" data-v-6a92bfa7> \u{1F4CA} Exporter </button><button class="btn btn-primary"${ssrIncludeBooleanAttr(!hasChanges.value || loading.value) ? " disabled" : ""} data-v-6a92bfa7> \u{1F4BE} Enregistrer tout </button></div></div><div class="table-container" data-v-6a92bfa7><table class="notes-table" data-v-6a92bfa7><thead data-v-6a92bfa7><tr data-v-6a92bfa7><th data-v-6a92bfa7>\xC9tudiant</th><!--[-->`);
        ...
        ssrRenderList(etudiants.value, (etudiant) => {
          ...
          _push(`<!--]--><td class="moyenne-cell" data-v-6a92bfa7><span class="${ssrRenderClass([getMoyenneClass(calculerMoyenne(etudiant.id)), "moyenne"])}" data-v-6a92bfa7>${ssrInterpolate(calculerMoyenne(etudiant.id).toFixed(2))}</span></td><td class="actions-cell" data-v-6a92bfa7><button class="btn btn-sm btn-secondary" data-v-6a92bfa7> \u{1F504} R\xE9initialiser </button><button class="btn btn-sm btn-danger" data-v-6a92bfa7> \u{1F5D1}\uFE0F Supprimer </button></td></tr>`);
        });
        _push(`<!--]--></tbody></table></div><div class="stats-section" data-v-6a92bfa7><h4 data-v-6a92bfa7>Statistiques de la mati\xE8re</h4><div class="stats-grid" data-v-6a92bfa7><div class="stat-card" data-v-6a92bfa7><div class="stat-label" data-v-6a92bfa7>Moyenne g\xE9n\xE9rale</div><div class="stat-value" data-v-6a92bfa7>${ssrInterpolate(stats.value.moyenneGenerale.toFixed(2))}</div></div><div class="stat-card" data-v-6a92bfa7><div class="stat-label" data-v-6a92bfa7>Note la plus haute</div><div class="stat-value" data-v-6a92bfa7>${ssrInterpolate(stats.value.noteMax.toFixed(2))}</div></div><div class="stat-card" data-v-6a92bfa7><div class="stat-label" data-v-6a92bfa7>Note la plus basse</div><div class="stat-value" data-v-6a92bfa7>${ssrInterpolate(stats.value.noteMin.toFixed(2))}</div></div><div class="stat-card" data-v-6a92bfa7><div class="stat-label" data-v-6a92bfa7>Taux de r\xE9ussite</div><div class="stat-value" data-v-6a92bfa7>${ssrInterpolate(stats.value.tauxReussite.toFixed(1))}%</div></div></div></div></div>`);
      } else {
        _push(`<div class="empty-state" data-v-6a92bfa7><div class="empty-icon" data-v-6a92bfa7>\u{1F4DA}</div><h3 data-v-6a92bfa7>S\xE9lectionnez un semestre pour commencer</h3><p data-v-6a92bfa7>Choisissez un semestre, une UE et une mati\xE8re pour visualiser et modifier les notes.</p></div>`);
      }
      if (showHistoryModal.value) {
        _push(`<div class="modal-overlay" data-v-6a92bfa7><div class="modal-content" data-v-6a92bfa7><div class="modal-header" data-v-6a92bfa7><h3 data-v-6a92bfa7>Historique des modifications</h3><button class="modal-close" data-v-6a92bfa7>\xD7</button></div><div class="modal-body" data-v-6a92bfa7><div class="history-list" data-v-6a92bfa7><!--[-->`);
...
export { modificationNotes as default };
//# sourceMappingURL=modification-notes-ChjsZVLj.mjs.map
