...
const _routes = [
  {
    ...
    component: () => import('./index-BOXmnXOa.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./login-D34VsApY.mjs')
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/bulletins",
    component: () => import('./bulletins-kZ1OKqx5.mjs'),
    children: [
      {
        name: "bulletins",
        path: "",
        component: () => import('./index-BpvoD05L.mjs')
      }
    ]
  },
  {
    name: "admin",
    path: "/admin",
    component: () => import('./index-Branj0aw.mjs')
  },
  {
    name: "profil",
    path: "/profil",
    component: () => import('./index-DDboTrx8.mjs')
  },
  {
    name: "saisie",
    path: "/saisie",
    component: () => import('./index-DSEMMOGn.mjs')
  },
  {
    name: "etudiant",
    path: "/etudiant",
    component: () => import('./index-pQ7HTxGA.mjs')
  },
  {
    name: "etudiants",
    path: "/etudiants",
    component: () => import('./index-d7NAAv_8.mjs')
  },
  {
    name: "enseignant",
    path: "/enseignant",
    component: () => import('./index-OIqT4BX5.mjs')
  },
  {
    name: "secretariat",
    path: "/secretariat",
    component: () => import('./index-DySAWk-Q.mjs')
  },
  {
    name: "referentiels",
    path: "/referentiels",
    component: () => import('./index-DUxkCsdC.mjs')
  },
  {
    name: "deliberations",
    path: "/deliberations",
    component: () => import('./index-DxSQTmHC.mjs')
  },
  {
    name: "secretariat-bulletins",
    path: "/secretariat/bulletins",
    component: () => import('./bulletins-pzfT4SXi.mjs')
  },
  {
    name: "secretariat-etudiants",
    path: "/secretariat/etudiants",
    component: () => import('./etudiants-DMNwjdEf.mjs')
  },
  {
    name: "secretariat-enseignants",
    path: "/secretariat/enseignants",
    component: () => import('./enseignants-DcjyTSF1.mjs')
  },
  {
    name: "secretariat-edition-bulletins",
    path: "/secretariat/edition-bulletins",
    component: () => import('./edition-bulletins-C6BmhYRG.mjs')
  },
  {
    name: "secretariat-modification-notes",
    path: "/secretariat/modification-notes",
    component: () => import('./modification-notes-ChjsZVLj.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-55Jy8w47.mjs').then((m) => m.default || m)),
  empty: defineAsyncComponent(() => import('./empty-BgR1QVJH.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-LB9OwEEF.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Cj2e9bel.mjs'));
